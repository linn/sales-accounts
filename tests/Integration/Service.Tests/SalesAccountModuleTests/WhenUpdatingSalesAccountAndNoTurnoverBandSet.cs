...
{
    using Domain;
    using Domain.Activities.SalesAccounts;
    ...
    using Resources.SalesAccounts;

    public class WhenUpdatingSalesAccountAndNoTurnoverBandSet : ContextBase
    {
        ...
        public void ShouldReturnResource()
        {
            ...
            resource.TurnoverBandUri.Should().BeNull();
